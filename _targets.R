...
tar_option_set(
  packages = c("dplyr", "sf", "terra", "stringr", "rdryad", "rinat", "dismo", "processNC", "geodata")
)
...
list(
  ...
  tar_target(corine_cha_che, build_corine_cha_che(filedir =  "/media/matt/Backup_2/EnvironmentalData/Corine/DATA")),
  tar_target(corine_lc_che, build_corine_lc_che(filedir =  "/media/matt/Backup_2/EnvironmentalData/Corine/DATA")),
  tar_target(glarus, build_glarus()),
  tar_target(inat_che_1965_2025, build_inat_che_1965_2021(filedir = "/media/matt/Backup_2/EnvironmentalData/")),
  tar_target(srtm_csi_che_3arc, build_srtm_csi_che_3arc(filedir =  "/media/matt/Backup_2/EnvironmentalData/SRTM")),
  tar_target(srtm3_che_3arc, build_srtm3_che_3arc(filedir =  "/media/matt/Backup_2/EnvironmentalData/SRTM")),
  tar_target(srtm3_glarus_1arc, build_srtm3_glarus_1arc(filedir=  "/media/matt/Backup_2/EnvironmentalData/SRTM")),
  ...
  tar_target(inat_che_1965_2025_rda, save_package_data(inat_che_1965_2025, "inat_che_1965_2021"), format = "file"),
